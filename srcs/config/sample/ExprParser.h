...
public:
  enum {
    AND = 1, OR = 2, NOT = 3, EQ = 4, COMMA = 5, SEMI = 6, DQUOTE = 7, LCURLY = 8, 
    RCURLY = 9, INT = 10, ID = 11, WS = 12, ANYCHAR = 13, NUMBER = 14
  };

  enum {
    RuleProgram = 0, RuleStatement = 1, RuleSimpleStatement = 2, RuleBlockStatement = 3, 
    RuleDirective = 4, RuleParameters = 5, RuleParameter = 6, RuleString = 7
  };
