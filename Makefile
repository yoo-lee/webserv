...
SOCKET 				:= fd_manager.cpp socket_data.cpp request.cpp response.cpp socket.cpp tcp_socket.cpp content_type.cpp transfer_encoding.cpp uri.cpp
...
DESIGN				:= iread.cpp
SRC					:= $(CONFIG_SRCS) $(SOCKET) $(CGI) $(SERVER) $(UTILITY) $(DESIGN)
